...
(function($) {
        ...
        return this.each(function() {
            ...
            var slide = function(isForward) {
                if ($root.data('sliding')) {
                    if (options.snap) {
                        $root.yajc('show', (isForward ? 'next' : 'prev') + options.step, function() {
                            off();
                        });
                    } else {
            ...
            if (options.snap || supportTouch) {
                ...
                if (supportTouch)
                    $bothWings.on(supportTouch ? 'touchend' : 'mouseup mouseout', off); 
    ...
    $.fn.yajc.plugins.flick = function(callback) {
        return this.each(function() {
            var $root = $(this),
